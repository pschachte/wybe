...
\newcommand{\lang}{\textsc{Frege}\xspace}
\newcommand{\Lang}{\textsc{Frege}\xspace}
...
\item A full module may be imported (\texttt{import} or \texttt{use}
  \emph{modulename}), or only certain specified members
  may be imported (\texttt{from} \emph{modulename} \emph{import}
  \emph{items} or \texttt{from} \emph{modulename} \emph{use}
  \emph{items}).
...
\begin{center}
  \begin{tabular}{|p{4cm}|p{7.5cm}|}
    \hline
    \texttt{import} \emph{modulename}
    & Imports everything from \emph{modulename} so that it can be used
    without module qualification.
    \\ \hline
    \texttt{use} \emph{modulename}
    & Imports everything from \emph{modulename} so that it can only be used
    with module qualification.
    \\ \hline
    \texttt{from} \emph{modulename} \texttt{import} \emph{items}
    & Imports the specified items from \emph{modulename} so that they
    can be used without module qualification.
    \\ \hline
    \texttt{from} \emph{modulename} \texttt{use} \emph{items}
    & Imports the specified items from \emph{modulename} so that they
    can only be used with module qualification.
    \\ \hline
    \texttt{public import} \emph{modulename}
    & Imports everything from \emph{modulename} so that it can be used
    without module qualification, and reexport it from the importing module.
    \\ \hline
    \texttt{public use} \emph{modulename}
    & Imports everything from \emph{modulename} so that it can only be used
    with module qualification, and reexport it from the importing module.
    \\ \hline
    \texttt{public from} \emph{modulename} \texttt{import} \emph{items}
    & Imports the specified items from \emph{modulename} so that they
    can be used without module qualification, and reexport them from the
    importing module.
    \\ \hline
    \texttt{public from} \emph{modulename} \texttt{use} \emph{items}
    & Imports the specified items from \emph{modulename} so that they
    can only be used with module qualification, and reexport them from the
    importing module.
    \\ \hline
  \end{tabular}
\end{center}
